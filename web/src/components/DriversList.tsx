      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 max-w-md w-full">
        ...
        <div className="space-y-4">
          {trip?.rideFares?.map((fare) => {
            const meta = PackagesMeta[fare.packageSlug as keyof typeof PackagesMeta];
            const Icon = meta?.icon;
            const price = fare.totalPriceInCents != null && `₹${(fare.totalPriceInCents / 100).toFixed(2)}`
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-medium">{meta?.name ?? fare.packageSlug}</h3>
